...
\homepage{a-pelenitsyn.github.io}                    % optional, remove the line if not wanted
...
\cventry{2018--present}{PhD student}{Northeastern U.}{Boston, USA}{Advisor: \textbf{Jan Vitek} (j.vitek@neu.edu)}{%\newline{}
}
...
\cventry%
    ...
    {Rostov-na-Donu, Russia}%
    {\myhref%
        {https://a-pelenitsyn.github.io/Files/Edu/Diploma/scans/diploma-euro-supplement-bsc.pdf}%
...
\cventry%
    ...
    {Southern Federal University}%
    {Rostov-na-Donu, Russia}%
    {\myhref{https://a-pelenitsyn.github.io/Files/Edu/Diploma/scans/diploma-euro-supplement-msc.pdf}{link to the transcript}}%
    {Major: Foundations and Software Engineering for Computer Science}
